...
```{r kmeanstable, echo = FALSE, eval = TRUE, message = FALSE}
clusters_count_top40
```
...
## Results
<figure>
  <img src="../results/05_heatmap_1_pos.png" alt="Top 10 upregulated genes" width="750"/>
  <figcaption><font size="3"> 
    Expression of the 10 most upregulated genes for the 6 leukemia types 
  </font></figcaption>
</figure>
