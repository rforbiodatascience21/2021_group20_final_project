...
## Results
### Kmeans with all genes
```{r kmeansplotall, out.width="45%"}
knitr::include_graphics((normalizePath("results/06_kmeans_barplot_all.png")))
```
...
## Results
### Kmeans with top 40 genes
```{r kmeansplot40, out.width="45%"}
knitr::include_graphics((normalizePath("results/06_kmeans_barplot_top40.png")))
```


## Results
### PCA with all genes
```{r pcaprojectionall, out.width="60%"}
knitr::include_graphics((normalizePath("results/07_pca_all.png")))
```


## Results
### PCA with all genes
```{r pcavariancenall, out.width="60%"}
knitr::include_graphics((normalizePath("results/07_pca_var_all.png")))
```


## Results
### PCA with top 40 genes
```{r pcaprojectiontop, out.width="60%"}
knitr::include_graphics((normalizePath("results/07_pca_top40.png")))
```


## Results
### PCA with top 40 genes
```{r pcavariancetop, out.width="60%"}
knitr::include_graphics((normalizePath("results/07_pca_var_top40.png")))
```
...
```{r heatmappaper, out.width="70%"}
knitr::include_graphics((normalizePath("doc/paper_heatmap.png")))
```
...
## Discussion
- The t-test is a good statistical test to seek for upregulated or downregulated genes in each type of leukemia.
