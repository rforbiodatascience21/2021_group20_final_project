...
## Results
### PCA with all genes
```{r pcaprojectionall, out.width="45%"}
...
## Results
### PCA with all genes
```{r pcavariancenall, out.width="45%"}
...
```{r pcaprojectiontop, out.width="45%"}
