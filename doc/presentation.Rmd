...
## Results | Kmeans with all genes
```{r kmeansplotall, out.width="45%", fig.align ='center'}
knitr::include_graphics(path = "../results/06_kmeans_barplot_all.png")
```


## Results | Kmeans with top 40 genes 
...
## Results | Kmeans with top 40 genes
```{r kmeansplot40, out.width="45%", fig.align ='center'}
knitr::include_graphics(path = "../results/06_kmeans_barplot_top40.png")
```


## Results | PCA with all genes
```{r pcaprojectionall, out.width="45%", fig.align ='center'}
knitr::include_graphics(path = "../results/07_pca_all.png")
```


## Results | PCA with all genes
```{r pcavariancenall, out.width="45%", fig.align ='center'}
knitr::include_graphics(path = "../results/07_pca_var_all.png")
```


## Results | PCA with top 40 genes
```{r pcaprojectiontop, out.width="45%", fig.align ='center'}
knitr::include_graphics(path = "../results/07_pca_top40.png")
```


## Results | PCA with top 40 genes
```{r pcavariancetop, out.width="45%", fig.align ='center'}
